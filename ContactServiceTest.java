...
public class ContactServiceTest {
    ...
    public void testAddContactDuplicateID() {
        ...
        Contact contact2 = new Contact("1234567890", "Jane", "Smith", "0987654321", "456 Main St");
    ...
    public void testUpdateContact() {
        Contact contact = new Contact("1234567890", "John", "Doe", "1234567890", "123 Main St");
        contactService.addContact(contact);
        contactService.updateContact("1234567890", "Jane", "Smith", "0987654321", "456 Main St");
        ...
        assertEquals("456 Main St", contactService.getContact("1234567890").getAddress());
    }

    @Test
    public void testUpdateContactNotFound() {
        assertThrows(IllegalArgumentException.class, () -> contactService.updateContact("1234567890", "Jane", "Smith", "0987654321", "456 Main St"));
    }
}
